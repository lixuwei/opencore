...
<!-- 中间 -->
		...
		<frame  src="<%=contextPath %>/jsp/login/rightframe.jsp" frameborder="no"  noresize="noresize" />
...
<!-- 中间 //-->
    ...
    <frame src="backMain!bottomFrame.action" name="bottomFrame" frameborder="no" scrolling="no" noresize="noresize" id="bottomFrame" title="bottomFrame" />
</frameset>
